...
const Testimonial = () => {
  return (
    <section className="flexCenter flex-col bg-white dark:bg-black">
      <div className="padding-container max-container w-full pb-24">
        {/* <p className="uppercase regular-18 -mt-1 mb-3 text-orange-500">Testimonial</p> */}
        <div className="flex flex-wrap justify-between gap-5 lg:gap-10">
          <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-20 w-full">
            <h2 className="bold-40 lg:bold-64 xl:max-w-[390px]">What our customers are saying</h2>
